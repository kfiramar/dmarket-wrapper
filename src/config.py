...
keys_config.read(os.path.join(SRC_PATH, '../keys.ini'),  encoding='utf-8')
...
ACTIVE_TARGETS_ENDPOINT = config['ENDPOINTS']['ACTIVE_TARGETS']
INACTIVE_TARGETS_ENDPOINT = config['ENDPOINTS']['INACTIVE_TARGETS']
...
RAINBOW_TABLE = config['TABLE']['RAINBOW_TABLE']
RAINBOW_SPEED = float(config['TABLE']['RAINBOW_SPEED'])
RAINBOW_DURATION = float(config['TABLE']['RAINBOW_DURATION'])
