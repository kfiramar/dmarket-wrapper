...
def listing():
    ...
    responses = request_devider(api_url_path=BUY_ORDER_ENDPOINT, method='POST', amount=int(amount), body_func=buy_order_body, price=price, asset_ids=choosen_row["asset_ids"])
