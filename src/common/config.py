...
MARKET_ITEMS_ENDPOINT = general_config['ENDPOINTS']['MARKET_ITEMS_ENDPOINT']
CREATE_TARGET_ENDPOINT = general_config['ENDPOINTS']['CREATE_TARGET_ENDPOINT']
VIEW_TARGETS_ENDPOINT = general_config['ENDPOINTS']['VIEW_TARGETS_ENDPOINT']
