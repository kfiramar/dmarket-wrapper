...
VALID_INVENTORY_ARGUMENTS = config['GENERAL']['VALID_INVENTORY_ARGUMENTS']
...
CREATE_TARGET_PRICE = config['TEXT']['QUESTIONS_TEXT']['CREATE_TARGET_PRICE']
CREATE_TARGET_AMOUNT = config['TEXT']['QUESTIONS_TEXT']['CREATE_TARGET_AMOUNT']
...
NO_ITEM = config['TEXT']['NORMAL_TEXT']['NO_ITEM']
